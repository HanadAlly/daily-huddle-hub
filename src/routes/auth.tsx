  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-background">
      <div className="absolute inset-0 -z-10 opacity-40"
        style={{ background: "radial-gradient(60% 50% at 50% 0%, oklch(0.52 0.19 268 / 0.18), transparent 70%)" }} />
      <div className="w-full max-w-md">
        ...
        <Card className="p-6 shadow-[var(--shadow-soft)]">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {mode === "signin" ? "Sign in to post today's update." : "Join your team's daily standup."}
          </p>
          ...
          >
            <svg className="size-4" viewBox="0 0 24 24" aria-hidden>
              <path fill="#4285F4" d="M22.5 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.07 5.07 0 0 1-2.2 3.32v2.77h3.56c2.08-1.92 3.22-4.74 3.22-8.1Z"/>
              ...
              <path fill="#FBBC05" d="M5.84 14.11A6.6 6.6 0 0 1 5.5 12c0-.74.13-1.45.34-2.11V7.05H2.18a11 11 0 0 0 0 9.9l3.66-2.84Z"/>
              <path fill="#EA4335" d="M12 5.38c1.62 0 3.07.56 4.21 1.64l3.15-3.15C17.46 2.1 14.97 1 12 1A11 11 0 0 0 2.18 7.05l3.66 2.84C6.71 7.3 9.14 5.38 12 5.38Z"/>
            </svg>
